...
9. **JSON转Excel导出**: 支持将JSON数组数据转换为Excel文件并下载到本地
...
**Issue 5 -- JSON数据导出不便:** 开发者经常需要将API返回的JSON数据导出为Excel进行数据分析或分享，现有工具需复制到在线转换网站，操作繁琐且存在数据泄露风险。
...
| v0.2 | 2026-05-14 | 新增JSON转Excel导出需求 (S-04) |
